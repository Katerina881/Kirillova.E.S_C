...
namespace TP_LABS
{
    public partial class FormBusConfig : Form
    {
        ...
        {
            InitializeComponent();
            panel1.MouseDown += panelBus_MouseDown;
            panel2.MouseDown += panelBus_MouseDown;
            panel3.MouseDown += panelBus_MouseDown;
            panel4.MouseDown += panelBus_MouseDown;
            panel5.MouseDown += panelBus_MouseDown;
            panel6.MouseDown += panelBus_MouseDown;
            panel7.MouseDown += panelBus_MouseDown;
            panel8.MouseDown += panelBus_MouseDown;
